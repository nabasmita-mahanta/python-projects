...
def generate_insert_query(result):
    ...
    sunrise_date_obj =datetime.datetime.fromtimestamp(sunrise)
    sunset = result["sys"]["sunset"]
    sunset_date_obj = datetime.datetime.fromtimestamp(sunset)
    ...
    query = (
        ...
        f"VALUES('{city_name}',{temperature},{temperature_feels_like},'{weather_main}','{weather_description}',{temperature_min},{temperature_max},{pressure},{humidity},{wind_speed},'{date_obj}','{country}','{sunrise_date_obj}','{sunset_date_obj}');")
    return query
